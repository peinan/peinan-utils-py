...
class Parser:
    ...
    def parse(self, text: str, only_content_words: bool = False, fit_stopwords: bool = False) -> list:
        results = []
    ...
    def get_surfaces(self, text: str, only_content_words: bool = False, fit_stopwords: bool = False) -> list:
        return [ res['surface'] for res in self.parse(text,
                                                      only_content_words=only_content_words,
                                                      fit_stopwords=fit_stopwords) ]

    def split_to_lines(self, text: str) -> list:
